...
export default function Header() {
  ...
  return isLoaded&&(
    ...
    <View style={[{justifyContent:'space-between'},styles.rowStyle]} >
      ...
      <View style={{backgroundColor:Colors.WHITE,paddingLeft:20,paddingRight:5,borderRadius:99,marginTop:25,display:'flex',flexDirection:'row',justifyContent:'space-between'}}>
...
const styles = StyleSheet.create({
    ...
    rowStyle:{display:'flex',flexDirection:'row',gap:10,alignItems:'center'}
})